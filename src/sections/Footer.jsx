                        ...
                        <div key={section}>
                            ...
                            <ul>
                                {section.links.map((link) => (
                                    <li key={link.name} className="text-white-400 mt-3 font-montserrat text-base leading-normal hover:text-slate-gray items-center ">
                                        <a href="">{link.name}</a>
                                    </li>
                                ))}
                            </ul>
...
<div className="flex flex-1 justify-start items-center gap-2 font-montserrat cursor-pointer">
  ...
  <p>Copyright. All rights reserved. Daniel Cipriano {new Date().getFullYear()}</p>
</div>
